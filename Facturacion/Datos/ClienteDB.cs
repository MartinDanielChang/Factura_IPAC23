...
namespace Datos
{
    ...
    {
        string cadena = "server=localhost; user=root; database=factura2; password=naranja29;";
        ...
        public bool Insertar(Cliente cliente)
        {
            ...
            {
                StringBuilder sql = new StringBuilder();
                sql.Append("INSERT INTO cliente VALUES  Identidad  ");
                ...
                using (MySqlConnection _conexion = new MySqlConnection(cadena))
                {
                    ...
                    using (MySqlCommand comando = new MySqlCommand(sql.ToString(), _conexion))
                    {
                        ...
                        comando.Parameters.Add("@FechaNacimineto", MySqlDbType.DateTime).Value = cliente.FechaNacimiento;
                        comando.Parameters.Add("@EstaActivo", MySqlDbType.Bit, 25).Value = cliente.EstaActivo;
